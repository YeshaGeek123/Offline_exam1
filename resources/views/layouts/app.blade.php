...
<body>
                    ...
                    <div class="navbar-header" data-logobg="skin6">
                        <a class="navbar-brand" href="{{ auth()->user()->role_id == 1 ? route('dashboard') : route(strtolower(auth()->user()->role->title).'-dashboard') }}">
                            ...
                            {{-- <span class="logo-text">
                                <img src="{{ asset('theme/plugins/images/srta-logo.jpg') }}" alt="homepage" />
                            </span> --}}
                        </a>
                    ...
                    <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                        ...
                        <div class="navbar-nav ms-auto d-flex align-items-center">
                            {{-- @if ( auth()->user()->role_id != 1 )    
                                <notification :unreads="{{ auth()->user()->unreadNotifications }}" :notifications="{{ auth()->user()->notifications()->get() }}" :user="{{ auth()->id() }}">
                                </notification>
                            @endif --}}
                            <ul class="navbar-nav">
    ...
    <script>
        ...
        //     const timeout = 240000;  // 900000 ms = 15 minutes
        //     var idleTimer = null;
        //     $('*').bind('mousemove click mouseup mousedown keydown keypress keyup submit change mouseenter scroll resize dblclick', function () {
        //         clearTimeout(idleTimer);

        //         idleTimer = setTimeout(function () {
        //             document.getElementById('ex-lg-frm').submit();
        //         }, timeout);
        //     });
